...
public class exercise_7 {
    ...
    private static void exercise1() {
        ...
        int ourNumber = Integer.valueOf(ourNumberStr);
    ...
    private static void exercise3() {
        ...
        String intStrToConvert = "6"; // Change this line
    ...
    private static void exercise4() {
        ...
        integerString *= 2;
        String integerAsAString = String.valueOf(integerString);
        integerAsAString += "10";
        double doubleString = Double.valueOf(integerAsAString);
        doubleString /= 3.5;;
