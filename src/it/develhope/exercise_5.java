...
public class exercise_5 {
    ...
    private static void exercise4Bonus() {
        ...
        //Math.ceil always rounds up and returns the smallest integer that is greater than or equal to ourValue
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));
        //Math.floor always rounds down and returns the largest integer that is less than or equal to ourValue
        ...
        //Math.pow in this case returns ourValue raised to the power of 2
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2));
        //Math.pow here instead returns ourValue raised to the power of 3
