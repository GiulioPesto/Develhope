...
public class exercise_14 {
     ...
     * A1:Do while loop, because the user has to do at least one action
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2:for each loop, because there are 1000 users to send emails to
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3:fori loop, because we want to print out the first 80 customer names from our bank
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4:while loop, because we want to read a file 100 lines at a time
     */
