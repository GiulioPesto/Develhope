package it.develhope.JavaAdvancedOOP.exercise_3;
...
public class exercise_3 {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        Person person = new Person("Maurizio", 30, "Via Maurizio Costanzo");
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        Person person1 = new Person("Fabrizio", 56, "Via Paolo Maldini");
        Person person2 = new Person("Fabrizio", 56, "Via Paolo Maldini");
