...
public class exercise_1 {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [It will print the following: apple, banana, orange, kiwi, mango; not ordered]
        ...
        //2b. What will this output? [It will print the following: apple, banana, grapes, pear, mango; not ordered]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise4() {
        ...
        for (Integer orderedNumber : orderedNumbers) {
            min = Math.min(min, orderedNumber);
        }
        if (min != 1) {
