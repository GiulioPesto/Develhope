...
public class exercise_1 {
    ...
    private static void exercise1() {
        ...
        String isGreaterOrEqual = x >= 50 ? "x is greater than 50 or equal" : "x is less than 50";
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        // Your code here
        Person mauricio = new Person("Mauricio", 60, "Via Fabricio Mauricio");
    ...
    private static void exercise3() {
        ...
        BigDecimal bigDecimal = new BigDecimal("0.000000000000000000000001");
        BigInteger bigResult = bigInteger.divide(new BigInteger("3"));
        BigDecimal bigResult2 = bigDecimal.divide(BigDecimal.valueOf(Math.PI), 50, RoundingMode.HALF_UP);
