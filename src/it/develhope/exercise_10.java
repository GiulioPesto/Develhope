...
public class exercise_10 {
    ...
    public static void exercise2() {
        ...
        switch (inputNumber) {
            case 2:
                ...
                break;
            case 3:
                System.out.println("This is the second prime number under 20");
                break;
            case 5:
                System.out.println("This is the third prime number under 20");
                break;
            case 7:
                System.out.println("This is the 4th prime number under 20");
                break;
            case 11:
                System.out.println("This is the 4th largest prime number under 20");
                break;
            case 13:
                System.out.println("This is the 6th prime number under 20");
                break;
            case 17:
                System.out.println("This is the 7th prime number under 20");
                break;
            case 19:
    ...
    /**
     * 3: BONUS! This is an optional task, but it is recommended you complete it
     * -------------------------------------------------------------------------
    ...
    public static void exercise3Bonus() {
        ...
        switch (inputNumber2) {
            case 2 -> System.out.println("This is the first prime number under 20");
            case 3 -> System.out.println("This is the second prime number under 20");
            case 5 -> System.out.println("This is the third prime number under 20");
            case 7 -> System.out.println("This is the 4th prime number under 20");
