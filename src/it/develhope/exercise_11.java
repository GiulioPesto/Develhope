...
public class exercise_11 {
    ...
    public static void exercise2() {
        ...
        menuItems.add("Pizza"); menuPrices.add(5.99);
        menuItems.add("Salad"); menuPrices.add(2.99);
        menuItems.add("Burger"); menuPrices.add(9.99);
        System.out.println("The cost of: " + menuItems.get(0) + " is " + menuPrices.get(0));
    }
